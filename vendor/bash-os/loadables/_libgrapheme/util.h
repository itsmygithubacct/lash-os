...
/* bash-os addition: terminal cell-width for codepoint cp. Returns 0 (zero-
 * width / combining / control), 1 (narrow), or 2 (East Asian Wide/Fullwidth).
 * Source data: Unicode 17.0.0 EAW + DerivedCoreProperties Grapheme_Extend. */
int bgr_cell_width(uint_least32_t cp);
