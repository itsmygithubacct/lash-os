 ...
 * Output: the serialized structure, plus public key pair
 */
 ...
 * Outputs: the serialized structure, plus two public key pairs
 */
                                    ...
                                    void *p_rng)
{
    ...
    /*
     * First generate public key pair (S: 7.4.2.5.1, C: 7.4.2.6.1)
     *
